    ...
    box.innerHTML = `
      <div class="card" style="margin-bottom:16px;padding:26px;">
        <div style="text-align:center;margin-bottom:22px;">
          ...
          <div style="font-size:12.5px;color:var(--text-muted);margin-top:4px;max-width:440px;margin-left:auto;margin-right:auto;">Gere um kit de 3 fotos profissionais prontas pra anunciar (2 ambientadas, cada uma focando um detalhe diferente, e 1 em perspectiva diagonal), a partir de 1 foto de referência.</div>
        </div>
        ...
        <div style="font-size:11px;color:var(--text-muted);margin-top:8px;text-align:center;">Kit fixo: 2 fotos ambientadas (cada uma com foco diferente) e 1 de perspectiva diagonal.</div>
